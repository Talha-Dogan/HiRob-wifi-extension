...
const int W_CLK_PIN = 26;
const int FQ_UD_PIN = 27;
...
int connectionCheckMax = 300;
String wifiDefaultName = "Dr.K";
String wifiDefaultPassword = "12345678";

//Mqtt Configurations
const char* mqttServer = "mqtt.drk.hsmteknoloji.com";
PubSubClient psClient(wifiClient);
String mqttUserName = "drk";
String mqttPassword = "Amca151200";
String mqttTopicBase = "drk/";
String mqttTopicDevice = "";
String mqttTopicConnect = "drk/connect";
String mqttTopicStatu = "drk/statu";
...
void ddsSetup() {
  if (debug) {
    Serial.println("Setting up Dds Device..");
  }
